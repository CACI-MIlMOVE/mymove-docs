...
const draw = (text, id, version) => {
  try {
    ...
    const root = sandboxElement !== void 0 && document !== void 0 && document !== null ? (0,d3__WEBPACK_IMPORTED_MODULE_0__/* .select */ .Ltv)(document) : (0,d3__WEBPACK_IMPORTED_MODULE_0__/* .select */ .Ltv)("body");
