...
/* harmony import */ var _svgDrawCommon_f26cad39_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(72516);
...
const drawPopup = function(elem, actor, minMenuWidth, textAttrs, forceMenus) {
  ...
  if (links != null) {
    ...
    for (let key in links) {
      ...
      var sanitizedLink = (0,_braintree_sanitize_url__WEBPACK_IMPORTED_MODULE_1__/* .sanitizeUrl */ .J)(links[key]);
...
const svgDraw = {
  ...
  popdownMenu,
  fixLifeLineHeights,
  sanitizeUrl: _braintree_sanitize_url__WEBPACK_IMPORTED_MODULE_1__/* .sanitizeUrl */ .J
};
let conf = {};
const bounds = {
  data: {
...
const draw = function(_text, id, _version, diagObj) {
  ...
  const actorLines = (0,d3__WEBPACK_IMPORTED_MODULE_0__/* .selectAll */ .Ubm)("#" + id + " .actor-line");
...
const drawImage = function(elem, x, y, link) {
  ...
  imageElem.attr("x", x);
  imageElem.attr("y", y);
  var sanitizedLink = (0,_braintree_sanitize_url__WEBPACK_IMPORTED_MODULE_0__/* .sanitizeUrl */ .J)(link);
...
const drawEmbeddedImage = function(elem, x, y, link) {
  ...
  imageElem.attr("x", x);
  imageElem.attr("y", y);
  const sanitizedLink = (0,_braintree_sanitize_url__WEBPACK_IMPORTED_MODULE_0__/* .sanitizeUrl */ .J)(link);
  imageElem.attr("xlink:href", "#" + sanitizedLink);
};
const getNoteRect = function() {
  return {
