...
/* harmony import */ var _svgDrawCommon_f26cad39_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(45120);
...
const draw = function(_text, id, _version, diagObj) {
  ...
  const actorLines = (0,d3__WEBPACK_IMPORTED_MODULE_0__/* .selectAll */ .COP)("#" + id + " .actor-line");
...
const drawImage = function(elem, x, y, link) {
  ...
  imageElem.attr("x", x);
  imageElem.attr("y", y);
  var sanitizedLink = (0,_braintree_sanitize_url__WEBPACK_IMPORTED_MODULE_0__/* .sanitizeUrl */ .o)(link);
