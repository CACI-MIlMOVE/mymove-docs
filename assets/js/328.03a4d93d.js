...
function assignMergeValue(object, key, value) {
  if ((value !== undefined && !(0,eq/* default */.c)(object[key], value)) ||
      (value === undefined && !(key in object))) {
    (0,_baseAssignValue/* default */.c)(object, key, value);
  }
}
...
var isPlainObject = __webpack_require__(86012);
...
function toPlainObject(value) {
  return (0,_copyObject/* default */.c)(value, (0,keysIn/* default */.c)(value));
}
...
function baseMergeDeep(object, source, key, srcIndex, mergeFunc, customizer, stack) {
  ...
  if (isCommon) {
    var isArr = (0,isArray/* default */.c)(srcValue),
        isBuff = !isArr && (0,isBuffer/* default */.c)(srcValue),
        isTyped = !isArr && !isBuff && (0,isTypedArray/* default */.c)(srcValue);

    newValue = srcValue;
    if (isArr || isBuff || isTyped) {
      if ((0,isArray/* default */.c)(objValue)) {
        newValue = objValue;
      }
      else if ((0,isArrayLikeObject/* default */.c)(objValue)) {
        newValue = (0,_copyArray/* default */.c)(objValue);
      }
      else if (isBuff) {
        isCommon = false;
        newValue = (0,_cloneBuffer/* default */.c)(srcValue, true);
      }
      else if (isTyped) {
        isCommon = false;
        newValue = (0,_cloneTypedArray/* default */.c)(srcValue, true);
      }
      else {
        newValue = [];
      }
    }
    else if ((0,isPlainObject/* default */.c)(srcValue) || (0,isArguments/* default */.c)(srcValue)) {
      newValue = objValue;
      if ((0,isArguments/* default */.c)(objValue)) {
        newValue = lodash_es_toPlainObject(objValue);
      }
      else if (!(0,isObject/* default */.c)(objValue) || (0,isFunction/* default */.c)(objValue)) {
        newValue = (0,_initCloneObject/* default */.c)(srcValue);
      }
    }
    else {
      isCommon = false;
...
function baseMerge(object, source, srcIndex, customizer, stack) {
  ...
  (0,_baseFor/* default */.c)(source, function(srcValue, key) {
    stack || (stack = new _Stack/* default */.c);
    if ((0,isObject/* default */.c)(srcValue)) {
...
function createAssigner(assigner) {
  return (0,_baseRest/* default */.c)(function(object, sources) {
    var index = -1,
    ...
    if (guard && (0,_isIterateeCall/* default */.c)(sources[0], sources[1], guard)) {
...
function buildLayoutGraph(inputGraph) {
  ...
  g.setGraph(
    lodash_es_merge({}, graphDefaults, selectNumberAttrs(graph, graphNumAttrs), pick/* default */.c(graph, graphAttrs))
  );
  ...
  forEach/* default */.c(inputGraph.edges(), function (e) {
    ...
    g.setEdge(
      e,
      lodash_es_merge({}, edgeDefaults, selectNumberAttrs(edge, edgeNumAttrs), pick/* default */.c(edge, edgeAttrs))
    );
  });
...
var _ListCache = __webpack_require__(61986);
 ...
 */
function stackClear() {
  this.__data__ = new _ListCache/* default */.c;
  this.size = 0;
}
...
var _Map = __webpack_require__(75660);
// EXTERNAL MODULE: ./node_modules/lodash-es/_MapCache.js + 14 modules
var _MapCache = __webpack_require__(86320);
...
function stackSet(key, value) {
  var data = this.__data__;
  if (data instanceof _ListCache/* default */.c) {
    var pairs = data.__data__;
    if (!_Map/* default */.c || (pairs.length < LARGE_ARRAY_SIZE - 1)) {
      pairs.push([key, value]);
      this.size = ++data.size;
      return this;
    }
    data = this.__data__ = new _MapCache/* default */.c(pairs);
  }
  data.set(key, value);
  this.size = data.size;
  return this;
...
function Stack(entries) {
  var data = this.__data__ = new _ListCache/* default */.c(entries);
  this.size = data.size;
}
...
/* harmony export */ });
/* harmony import */ var _root_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(43936);


/** Built-in value references. */
var Uint8Array = _root_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .c.Uint8Array;
...
var _isIndex = __webpack_require__(78367);
// EXTERNAL MODULE: ./node_modules/lodash-es/isTypedArray.js + 1 modules
var isTypedArray = __webpack_require__(93416);
...
function arrayLikeKeys(value, inherited) {
  var isArr = (0,isArray/* default */.c)(value),
      isArg = !isArr && (0,isArguments/* default */.c)(value),
      isBuff = !isArr && !isArg && (0,isBuffer/* default */.c)(value),
      isType = !isArr && !isArg && !isBuff && (0,isTypedArray/* default */.c)(value),
  ...
  for (var key in value) {
    if ((inherited || _arrayLikeKeys_hasOwnProperty.call(value, key)) &&
        !(skipIndexes && (
           ...
           (0,_isIndex/* default */.c)(key, length)
        ))) {
      result.push(key);
    }
  }
...
/* harmony export */   c: () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _baseAssignValue_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(78848);
/* harmony import */ var _eq_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(73048);
...
function assignValue(object, key, value) {
  ...
  if (!(hasOwnProperty.call(object, key) && (0,_eq_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .c)(objValue, value)) ||
      (value === undefined && !(key in object))) {
    (0,_baseAssignValue_js__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .c)(object, key, value);
  }
}
...
/* harmony export */   c: () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _defineProperty_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(5048);
...
function baseAssignValue(object, key, value) {
  if (key == '__proto__' && _defineProperty_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .c) {
    (0,_defineProperty_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .c)(object, key, {
      'configurable': true,
      'enumerable': true,
      'value': value,
      'writable': true
...
/* harmony export */   c: () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _identity_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(5816);
/* harmony import */ var _overRest_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(10648);
/* harmony import */ var _setToString_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(99669);
...
function baseRest(func, start) {
  return (0,_setToString_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .c)((0,_overRest_js__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .c)(func, start, _identity_js__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .c), func + '');
}
...
/* harmony export */   c: () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _Uint8Array_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(91392);
...
function cloneArrayBuffer(arrayBuffer) {
  ...
  new _Uint8Array_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .c(result).set(new _Uint8Array_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .c(arrayBuffer));
  return result;
}
...
/** Built-in value references. */
var Buffer = moduleExports ? _root_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .c.Buffer : undefined,
...
/* harmony export */   c: () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _cloneArrayBuffer_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(40976);
...
function cloneTypedArray(typedArray, isDeep) {
  var buffer = isDeep ? (0,_cloneArrayBuffer_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .c)(typedArray.buffer) : typedArray.buffer;
...
/* harmony export */   c: () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _assignValue_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(77412);
/* harmony import */ var _baseAssignValue_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(78848);
...
function copyObject(source, props, object, customizer) {
  ...
  while (++index < length) {
    ...
    if (isNew) {
      (0,_baseAssignValue_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .c)(object, key, newValue);
    } else {
      (0,_assignValue_js__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .c)(object, key, newValue);
    }
  }
  return object;
}
...
/* harmony export */   c: () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _getNative_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(95024);


var defineProperty = (function() {
  try {
    var func = (0,_getNative_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .c)(Object, 'defineProperty');
    func({}, '', {});
    return func;
  } catch (e) {}
}());
...
/* harmony export */   c: () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _overArg_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(51624);


/** Built-in value references. */
var getPrototype = (0,_overArg_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .c)(Object.getPrototypeOf, Object);
...
/* harmony import */ var _isIndex_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(78367);
...
var _isPrototype = __webpack_require__(57480);
...
function initCloneObject(object) {
  return (typeof object.constructor == 'function' && !(0,_isPrototype/* default */.c)(object))
    ? _baseCreate((0,_getPrototype/* default */.c)(object))
    : {};
}
...
/* harmony import */ var _isArrayLike_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(42440);
/* harmony import */ var _isIndex_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(78367);
/* harmony import */ var _isObject_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(5368);
...
function isIterateeCall(value, index, object) {
  if (!(0,_isObject_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .c)(object)) {
    return false;
  }
  var type = typeof index;
  if (type == 'number'
        ? ((0,_isArrayLike_js__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .c)(object) && (0,_isIndex_js__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .c)(index, object.length))
        : (type == 'string' && index in object)
      ) {
    return (0,_eq_js__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .c)(object[index], value);
  }
  return false;
}
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  c: () => (/* binding */ _setToString)
});

// EXTERNAL MODULE: ./node_modules/lodash-es/constant.js
var constant = __webpack_require__(11160);
// EXTERNAL MODULE: ./node_modules/lodash-es/_defineProperty.js
var _defineProperty = __webpack_require__(5048);
// EXTERNAL MODULE: ./node_modules/lodash-es/identity.js
var identity = __webpack_require__(5816);
 ...
 */
var baseSetToString = !_defineProperty/* default */.c ? identity/* default */.c : function(func, string) {
  return (0,_defineProperty/* default */.c)(func, 'toString', {
    'configurable': true,
    'enumerable': false,
    'value': (0,constant/* default */.c)(string),
    'writable': true
  });
};
...
function isArrayLikeObject(value) {
  return (0,_isObjectLike_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .c)(value) && (0,_isArrayLike_js__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .c)(value);
}
...
/* harmony import */ var _getPrototype_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(75388);
/* harmony import */ var _isObjectLike_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(23584);
...
function isPlainObject(value) {
  if (!(0,_isObjectLike_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .c)(value) || (0,_baseGetTag_js__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .c)(value) != objectTag) {
    return false;
  }
  var proto = (0,_getPrototype_js__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .c)(value);
  if (proto === null) {
    return true;
  }
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  c: () => (/* binding */ lodash_es_keysIn)
});

// EXTERNAL MODULE: ./node_modules/lodash-es/_arrayLikeKeys.js + 1 modules
var _arrayLikeKeys = __webpack_require__(46900);
// EXTERNAL MODULE: ./node_modules/lodash-es/isObject.js
var isObject = __webpack_require__(5368);
// EXTERNAL MODULE: ./node_modules/lodash-es/_isPrototype.js
var _isPrototype = __webpack_require__(57480);
...
function baseKeysIn(object) {
  ...
  var isProto = (0,_isPrototype/* default */.c)(object),
      result = [];
...
function keysIn(object) {
  return (0,isArrayLike/* default */.c)(object) ? (0,_arrayLikeKeys/* default */.c)(object, true) : _baseKeysIn(object);
}
...
var mermaid_aad43469 = __webpack_require__(71582);
...
/* harmony export */ });
/* harmony import */ var _mermaid_aad43469_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(71582);
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(66408);
/* harmony import */ var _createText_a49d2d2a_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(7512);
/* harmony import */ var _svgDraw_95adee0a_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(80956);
...
const insertEdge = function(elem, e, edge, clusterDb, diagramType, graph) {
  ...
  if (diagramType === "graph" || diagramType === "flowchart") {
    curve = edge.curve || d3__WEBPACK_IMPORTED_MODULE_0__/* .curveBasis */ .k7;
  } else {
...
/* harmony export */ });
/* harmony import */ var _flowDb_9e6c6aac_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(3540);
/* harmony import */ var _styles_7882abfe_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(43952);
/* harmony import */ var _mermaid_aad43469_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(71582);
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(66408);
/* harmony import */ var dagre_d3_es_src_graphlib_index_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(95536);
/* harmony import */ var dagre_d3_es_src_dagre_index_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(42408);
...
/* harmony import */ var dompurify__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(66296);
...
/* harmony export */ });
/* harmony import */ var dagre_d3_es_src_dagre_index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(42408);
/* harmony import */ var dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(58408);
/* harmony import */ var _edges_66ea8538_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(25920);
/* harmony import */ var _mermaid_aad43469_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(71582);
/* harmony import */ var dagre_d3_es_src_graphlib_index_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(95536);
/* harmony import */ var _createText_a49d2d2a_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(7512);
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(66408);
...
const adjustClustersAndEdges = (graph, depth) => {
  ...
  _mermaid_aad43469_js__WEBPACK_IMPORTED_MODULE_4__.l.warn("Adjusted Graph", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .G(graph));
  extractor(graph, 0);
  _mermaid_aad43469_js__WEBPACK_IMPORTED_MODULE_4__.l.trace(clusterDb);
};
const extractor = (graph, depth) => {
  _mermaid_aad43469_js__WEBPACK_IMPORTED_MODULE_4__.l.warn("extractor - ", depth, dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .G(graph), graph.children("D"));
  if (depth > 10) {
  ...
  for (const node of nodes) {
    ...
    graph.children(node) && graph.children(node).length > 0) {
      ...
      _mermaid_aad43469_js__WEBPACK_IMPORTED_MODULE_4__.l.warn("Old graph before copy", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .G(graph));
      ...
      _mermaid_aad43469_js__WEBPACK_IMPORTED_MODULE_4__.l.warn("New graph after copy node: (", node, ")", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .G(clusterGraph));
      _mermaid_aad43469_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("Old graph after copy", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .G(graph));
    } else {
      _mermaid_aad43469_js__WEBPACK_IMPORTED_MODULE_4__.l.warn(
        "Cluster ** ",
        node,
...
const recursiveRender = async (_elem, graph, diagramtype, parentCluster) => {
  _mermaid_aad43469_js__WEBPACK_IMPORTED_MODULE_4__.l.info("Graph in recursive render: XXX", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .G(graph), parentCluster);
  ...
  _mermaid_aad43469_js__WEBPACK_IMPORTED_MODULE_4__.l.info("Graph after layout:", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .G(graph));
  let diff = 0;
...
const render = async (elem, graph, markers, diagramtype, id) => {
  ...
  clear();
  clear$1();
  _mermaid_aad43469_js__WEBPACK_IMPORTED_MODULE_4__.l.warn("Graph at first:", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .G(graph));
  adjustClustersAndEdges(graph);
  _mermaid_aad43469_js__WEBPACK_IMPORTED_MODULE_4__.l.warn("Graph after:", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .G(graph));
...
var src = __webpack_require__(66408);
// EXTERNAL MODULE: ./node_modules/mermaid/dist/flowDb-9e6c6aac.js
var flowDb_9e6c6aac = __webpack_require__(3540);
// EXTERNAL MODULE: ./node_modules/mermaid/dist/mermaid-aad43469.js + 8 modules
var mermaid_aad43469 = __webpack_require__(71582);
// EXTERNAL MODULE: ./node_modules/mermaid/dist/index-1e7f2254.js
var index_1e7f2254 = __webpack_require__(88184);
...
const addEdges = function(edges, g, diagObj) {
  ...
  edges.forEach(function(edge) {
    ...
    if (edge.interpolate !== void 0) {
      edgeData.curve = (0,mermaid_aad43469.o)(edge.interpolate, src/* curveLinear */.qGi);
    } else if (edges.defaultInterpolate !== void 0) {
      edgeData.curve = (0,mermaid_aad43469.o)(edges.defaultInterpolate, src/* curveLinear */.qGi);
    } else {
      edgeData.curve = (0,mermaid_aad43469.o)(conf.curve, src/* curveLinear */.qGi);
    }
    if (edge.text === void 0) {
      if (edge.style !== void 0) {
