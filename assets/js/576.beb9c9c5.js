...
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(66408);
    ...
    if (resultTickInterval !== null) {
      ...
      switch (interval) {
        ...
        case "day":
          ...
          break;
        case "week":
          bottomXAxis.ticks(d3__WEBPACK_IMPORTED_MODULE_5__/* .timeWeek */ .slV.every(every));
          break;
        case "month":
      ...
      if (resultTickInterval !== null) {
        ...
        switch (interval) {
          ...
          case "day":
            ...
            break;
          case "week":
            topXAxis.ticks(d3__WEBPACK_IMPORTED_MODULE_5__/* .timeWeek */ .slV.every(every));
            break;
          case "month":
