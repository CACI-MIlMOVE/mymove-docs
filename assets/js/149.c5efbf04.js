...
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(25305);
...
const setLink = function(ids, _linkStr) {
  ...
  if ((0,_mermaid_aad43469_js__WEBPACK_IMPORTED_MODULE_7__.c)().securityLevel !== "loose") {
    linkStr = (0,_braintree_sanitize_url__WEBPACK_IMPORTED_MODULE_0__/* .sanitizeUrl */ .J)(_linkStr);
  }
    ...
    if (resultTickInterval !== null) {
      ...
      switch (interval) {
        ...
        case "day":
          ...
          break;
        case "week":
          bottomXAxis.ticks(d3__WEBPACK_IMPORTED_MODULE_5__/* .timeWeek */ .Kgo.every(every));
          break;
        case "month":
      ...
      if (resultTickInterval !== null) {
        ...
        switch (interval) {
          ...
          case "day":
            ...
            break;
          case "week":
            topXAxis.ticks(d3__WEBPACK_IMPORTED_MODULE_5__/* .timeWeek */ .Kgo.every(every));
            break;
          case "month":
